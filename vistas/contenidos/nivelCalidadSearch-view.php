...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR NIVEL DE CALIDAD
    </h3>
...
<div class="container-fluid">
    ...
    <li>
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL;?>nivelCalidadSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR NIVEL DE CALIDAD</a>
        </li>
    </ul>
</div>
