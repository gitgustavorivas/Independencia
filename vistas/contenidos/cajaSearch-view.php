...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL;?>cajaNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVA CAJA</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL;?>cajaList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CAJAS</a>
        </li>
        <li>
            <a class="<?php echo SERVERURL;?>active/" href="cajaSearch"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CAJA</a>
        </li>
    </ul>
</div>
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">¿Cual Caja Estas Buscando?</label>
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <th>ACTIVO</th>
                    <td>
                        <a href="cajaUpdate" class="btn btn-success">
