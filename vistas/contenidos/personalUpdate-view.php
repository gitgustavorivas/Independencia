...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR PERSONAL
    </h3>
    <p class="text-center">YERBA MATE INDEPENDENCIA...
    </p>
    <p class="text-jus">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL;?>userNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PERSONAL</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL;?>userList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PERSONAL</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL;?>userSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PERSONAL</a>
        </li>
    </ul>
</div>
