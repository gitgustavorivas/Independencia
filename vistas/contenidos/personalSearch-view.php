...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PERSONAL
    </h3>
    <p class="text-center">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL;?>personalSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PERSONAL</a>
        </li>
    </ul>
</div>
...
<?php } else { ?>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>“<?php echo $_SESSION['busqueda_personal']; ?>”</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        echo $ins_personal->paginador_personal_controlador(
            $pagina[1],
            15,
            $_SESSION['privilegio'],
            $_SESSION['id'],
            $pagina[0],
            $_SESSION['busqueda_personal']
        );
