...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA ORDEN DE PRODUCCION
    </h3>
    <p class="text-center">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL;?>ordProductionNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ORDEN DE PRODUCCION</a>
        </li>
        <li>
            <a class="active" href="<?php echo SERVERURL;?>ordProductionSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ORDEN DE PRODUCCION</a>
        </li>
        <li>
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <td>YERBA MATE</td>
                    <td>
                        <a href="ordProductionUpdate" class="btn btn-success">
