...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR DETALLE DE PRODUCCION
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL;?>detProductionSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR DETALLE DE PRODUCCION</a>
        </li>
    </ul>
</div>
