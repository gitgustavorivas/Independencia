...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO FORMA DE PAGO.
    </h3>
    <p class="text-center">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?php echo SERVERURL;?>formaPagoNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR FORMA PAGO</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL;?>formaPagoList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTAR FORMA PAGO</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL;?>formaPagoSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR FORMA PAGO</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
    <form action="" class="form-neon" autocomplete="off">
        <fieldset>
            <legend><i class="far fa-plus-square"></i> &nbsp; INFORMACION FORMA PAGO</legend>
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="etapa_Descripcion" class="bmd-label-floating">Forma Pago</label>
