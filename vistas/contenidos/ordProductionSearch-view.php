...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ORDEN DE PRODUCCION
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="ordProductionSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ORDEN DE PRODUCCION</a>
        </li>
    </ul>
</div>
