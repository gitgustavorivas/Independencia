...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR DATOS DE PRODUCCION
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL;?>ProductionNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR NUEVA DE PRODUCCION</a>
        </li>
        <li>
