...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR USUARIO</h3>
    <p class="text-justify">YERBA MATE INDEPENDENCIA...</p>
    <p class="text-jus">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL;?>userSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR USUARIO</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
    <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST"
        data-form="search" autocomplete="off">
        <input type="hidden" name="modulo" value="usuario">
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <p class="text-center" style="font-size: 20px;">
                        Resultados de la busqueda <strong>“<?php echo $_SESSION['busqueda_usuario']; ?>
                        </strong>
                    </p>
                </div>
                <div class="col-12">
...
<div class="container-fluid">
    <?php 
        ...
        $_SESSION['id'], $pagina[0], $_SESSION['busqueda_usuario']);
