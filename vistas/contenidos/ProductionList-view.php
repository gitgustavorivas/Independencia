...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PRODUCCION
    </h3>
    <p class="text-center">
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL;?>ProductionNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR PRODUCCION</a>
        </li>
        <li>
            <a class="active" href="<?php echo SERVERURL;?>ProductionList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PRODUCCION</a>
        </li>
        <li>
