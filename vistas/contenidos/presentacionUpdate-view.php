...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR PRESENTACION
    </h3>
...
<div class="container-fluid">
    ...
    $datos_presentacion = $ins_presentacion->datos_presentacion_controlador("Unico", $pagina[1]);
    ...
    if ($datos_presentacion->rowCount() == 1) {
        ...
        <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/presentacionAjax.php" method="POST"
            ...
            <fieldset>
                <legend><i class="fas fa-user"></i> &nbsp; ACTUALIZANDO DATOS DE PRESENTACIONES</legend>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="presentacion_descripcion_up" class="bmd-label-floating">Descripcion</label>
                                <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,100}" class="form-control"
                                    name="presentacion_descripcion_up" id="presentacion_descripcion_up" maxlength="100"
                                    value="<?php echo $campos['descripcion']; ?>" required="">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="presentacion_unimedida_up" class="bmd-label-floating">Unidad Medida</label>
                                <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,100}" class="form-control"
                                    name="presentacion_unimedida_up" id="presentacion_unimedida_up" maxlength="40"
