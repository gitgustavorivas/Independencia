...
if (isset($_POST['cliente_nombre_reg']) || isset($_POST['cliente_id_del']) || isset($_POST['cliente_id_up'])) {
    ...
    /*----------------Agregar un Cliente-----------------*/
    if (isset($_POST['cliente_nombre_reg']) && isset($_POST['cliente_apellido_reg'])) {
